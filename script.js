  ...
  if (savedData != null){
    if (savedData.length > 0){
      for (let i=0; i<savedData.length; i++){
        ...
        searchedCity.classList.add("btn", "btn-secondary", "btn-lg", "btn-block", "city");
...
function displayWeather(city_name) {
  ...
  let weatherData = fetch(
    `http://api.openweathermap.org/geo/1.0/direct?q=${city_name}&limit=1&appid=5fed619e7304f60a938b70a219a457d0`
  )
